...
public class SubAdapters implements CommonConstant{    
    ...
    public static class BasePersonInsertSubAdapter implements IMessageAdapter<Integer>{
        /** 订阅频道 */
        final Channel<Integer> channel = PUBSUB_PERSON_INSERT.clone().setAdapter(this);
        /**
    ...
    public static class BasePersonUpdateSubAdapter implements IMessageAdapter<Integer>{
        /** 订阅频道 */
        final Channel<Integer> channel = PUBSUB_PERSON_UPDATE.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return
    ...
    public static class BasePersonDeleteSubAdapter implements IMessageAdapter<Integer>{
        /** 订阅频道 */
        final Channel<Integer> channel = PUBSUB_PERSON_DELETE.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return
    ...
    public static class BaseFeatureInsertSubAdapter implements IMessageAdapter<String>{
        /** 订阅频道 */
        final Channel<String> channel = PUBSUB_FEATURE_INSERT.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return
    ...
    public static class BaseFeatureUpdateSubAdapter implements IMessageAdapter<String>{
        /** 订阅频道 */
        final Channel<String> channel = PUBSUB_FEATURE_UPDATE.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return
    ...
    public static class BaseFeatureDeleteSubAdapter implements IMessageAdapter<String>{
        /** 订阅频道 */
        final Channel<String> channel = PUBSUB_FEATURE_DELETE.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return
    ...
    public static class BasePermitInsertSubAdapter implements IMessageAdapter<PermitBean>{
        /** 订阅频道 */
        final Channel<PermitBean> channel = PUBSUB_PERMIT_INSERT.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return
    ...
    public static class BasePermitUpdateSubAdapter implements IMessageAdapter<PermitBean>{
        /** 订阅频道 */
        final Channel<PermitBean> channel = PUBSUB_PERMIT_UPDATE.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return
    ...
    public static class BasePermitDeleteSubAdapter implements IMessageAdapter<PermitBean>{
        /** 订阅频道 */
        final Channel<PermitBean> channel = PUBSUB_PERMIT_DELETE.clone().setAdapter(this);
        /**
         * 向{@code subscriber}注册,注册后才能收到订阅消息
         * @param subscriber 
         * @return

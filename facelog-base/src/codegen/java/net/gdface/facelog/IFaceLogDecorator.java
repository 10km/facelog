...
// template: decorator/decorator.class.vm
// ______________________________________________________
...
public class IFaceLogDecorator implements IFaceLog{
    ...
    /**
     * @return IFaceLog 返回被装饰的{@link IFaceLog}实例
     */
     ...
     * 所有显式申明的异常都被封装到{@link RuntimeException}抛出<br>
     * @param logBeans logBeans
     * @param faceBeans faceBeans
     * @param featureImages featureImages
     * @param token token
     * @return void
     */

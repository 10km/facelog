...
service IFaceLog {
  FeatureBean addFeature(1:  binary feature, 2: optional i32 personId, 3:  list<FaceBean> faecBeans, 4:  Token token) throws (1: DuplicateRecordException ex1, 2: ServiceRuntimeException ex2);
  FeatureBean addFeatureMulti(1:  binary feature, 2: optional i32 personId, 3:  map<binary, FaceBean> faceInfo, 4: optional i32 deviceId, 5:  Token token) throws (1: DuplicateRecordException ex1, 2: ServiceRuntimeException ex2);
  ImageBean addImage(1:  binary imageData, 2: optional i32 deviceId, 3:  FaceBean faceBean, 4: optional i32 personId, 5:  Token token) throws (1: DuplicateRecordException ex1, 2: ServiceRuntimeException ex2);
  void addLog(1:  LogBean bean, 2:  Token token) throws (1: DuplicateRecordException ex1, 2: ServiceRuntimeException ex2);
  void addLogs(1:  list<LogBean> beans, 2:  Token token) throws (1: DuplicateRecordException ex1, 2: ServiceRuntimeException ex2);
  ...
  void addPermitById(1: required i32 deviceGroupId, 2: required i32 personGroupId, 3:  Token token) throws (1: ServiceRuntimeException ex1);
  string applyAckChannel(1:  Token token) throws (1: ServiceRuntimeException ex1);
  string applyAckChannelWithDuration(1:  Token token, 2: required i64 duration) throws (1: ServiceRuntimeException ex1);
  i64 applyCmdSn(1:  Token token) throws (1: ServiceRuntimeException ex1);
  Token applyPersonToken(1: required i32 personId, 2:  string password, 3: required bool isMd5) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  Token applyRootToken(1:  string password, 2: required bool isMd5) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  ...
  i32 deleteAllFeaturesByPersonId(1: required i32 personId, 2: required bool deleteImage, 3:  Token token) throws (1: ServiceRuntimeException ex1);
  i32 deleteDeviceGroup(1: required i32 deviceGroupId, 2:  Token token) throws (1: ServiceRuntimeException ex1);
  list<string> deleteFeature(1:  string featureMd5, 2: required bool deleteImage, 3:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  i32 deletePerson(1: required i32 personId, 2:  Token token) throws (1: ServiceRuntimeException ex1);
  i32 deletePersonByPapersNum(1:  string papersNum, 2:  Token token) throws (1: ServiceRuntimeException ex1);
  i32 deletePersonGroup(1: required i32 personGroupId, 2:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  void disablePerson(1: required i32 personId, 2:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  list<bool> getGroupPermits(1: required i32 deviceId, 2:  list<i32> personGroupIdList) throws (1: ServiceRuntimeException ex1);
  ...
  list<bool> getPersonPermits(1: required i32 deviceId, 2:  list<i32> personIdList) throws (1: ServiceRuntimeException ex1);
  ...
  string getProperty(1:  string key, 2:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  bool isValidAckChannel(1:  string ackChannel) throws (1: ServiceRuntimeException ex1);
  bool isValidCmdSn(1: required i64 cmdSn) throws (1: ServiceRuntimeException ex1);
  bool isValidPassword(1:  string userId, 2:  string password, 3: required bool isMd5, 4:  Token token) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  ...
  list<DeviceBean> loadDeviceByWhere(1:  string where, 2: required i32 startRow, 3: required i32 numRows) throws (1: ServiceRuntimeException ex1);
  list<i32> loadDeviceGroupByWhere(1:  string where, 2: required i32 startRow, 3: required i32 numRows) throws (1: ServiceRuntimeException ex1);
  ...
  list<LogBean> loadLogByWhere(1:  string where, 2: required i32 startRow, 3: required i32 numRows) throws (1: ServiceRuntimeException ex1);
  ...
  list<LogLightBean> loadLogLightByWhere(1:  string where, 2: required i32 startRow, 3: required i32 numRows) throws (1: ServiceRuntimeException ex1);
  list<PermitBean> loadPermitByUpdate(1: required i64 timestamp) throws (1: ServiceRuntimeException ex1);
  list<PersonBean> loadPersonByWhere(1:  string where, 2: required i32 startRow, 3: required i32 numRows) throws (1: ServiceRuntimeException ex1);
  list<i32> loadPersonGroupByWhere(1:  string where, 2: required i32 startRow, 3: required i32 numRows) throws (1: ServiceRuntimeException ex1);
  ...
  void offline(1:  Token token) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  Token online(1:  DeviceBean device) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  DeviceBean registerDevice(1:  DeviceBean newDevice) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  void releasePersonToken(1:  Token token) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  void releaseRootToken(1:  Token token) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);
  void replaceFeature(1: optional i32 personId, 2:  string featureMd5, 3: required bool deleteOldFeatureImage, 4:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  PersonBean savePersonFull(1:  PersonBean bean, 2:  binary idPhoto, 3:  binary feature, 4:  binary featureImage, 5:  FaceBean featureFaceBean, 6: optional i32 deviceId, 7:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  PersonBean savePersonWithPhotoAndFeature(1:  PersonBean bean, 2:  binary idPhoto, 3:  FeatureBean featureBean, 4: optional i32 deviceId, 5:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  PersonBean savePersonWithPhotoAndFeatureMultiImage(1:  PersonBean bean, 2:  binary idPhoto, 3:  binary feature, 4:  map<binary, FaceBean> faceInfo, 5: optional i32 deviceId, 6:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  void setPersonExpiryDate(1: required i32 personId, 2: required i64 expiryDate, 3:  Token token) throws (1: ServiceRuntimeException ex1);
  void setPersonExpiryDateList(1:  list<i32> personIdList, 2: required i64 expiryDate, 3:  Token token) throws (1: ServiceRuntimeException ex1);
  ...
  void unregisterDevice(1: required i32 deviceId, 2:  Token token) throws (1: ServiceSecurityException ex1, 2: ServiceRuntimeException ex2);

...
service IFaceLog {
  ...
  void addLogs(1:  list<LogBean> beans);
  void addPermit(1:  DeviceGroupBean deviceGroup, 2:  PersonGroupBean personGroup);
  void addPermitById(1:  i32 deviceGroupId, 2:  i32 personGroupId);
  i32 countLogByWhere(1:  string where);
  i32 countLogLightByVerifyTime(1:  i64 timestamp);
  i32 countLogLightByWhere(1:  string where);
  ...
  i32 deletePermit(1:  DeviceGroupBean deviceGroup, 2:  PersonGroupBean personGroup);
  ...
  list<DeviceGroupBean> getDeviceGroups(1:  list<i32> groupIdList);
  list<DeviceBean> getDevices(1:  list<i32> idList);
  ...
  list<FeatureBean> getFeatures(1:  list<string> md5);
  bool getGroupPermit(1:  i32 deviceId, 2:  i32 personGroupId);
  list<bool> getGroupPermits(1:  i32 deviceId, 2:  list<i32> personGroupIdList);
  ...
  list<PersonGroupBean> getPersonGroups(1:  list<i32> groupIdList);
  bool getPersonPermit(1:  i32 deviceId, 2:  i32 personId);
  list<bool> getPersonPermits(1:  i32 deviceId, 2:  list<i32> personIdList);
  ...
  list<LogLightBean> loadLogLightByVerifyTime(1:  i64 timestamp, 2:  i32 startRow, 3:  i32 numRows);
  ...
  list<i32> loadPersonIdByUpdateTime(1:  i64 timestamp);
  ...
  void savePersons(1:  list<PersonBean> beans);

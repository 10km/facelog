...
public class ClientTools {
	...
	public ClientTools(IFaceLogThriftClient syncInstance) {
		super();
		this.syncInstance = checkNotNull(syncInstance,"syncInstance is null");
	}
	public ClientTools(IFaceLogThriftClientAsync asyncInstance) {
		super();
   ...
   ///////////////// CLIENT EXTENSIVE CONVENIENCE TOOLS /////////////
    ...
    public final com.google.common.base.Function<Integer,Integer> deviceGroupIdGetter = 
        ...
        public Integer apply(Integer input) {
            try{
                DeviceBean device = syncInstance != null ? syncInstance.getDevice(input) : asyncInstance.getDevice(input).get();
    ...
    public final com.google.common.base.Function<Integer,List<Integer>> personGroupBelonsGetter = 
        ...
        public List<Integer> apply(Integer personId) {
            try{
                return syncInstance != null ? syncInstance.getPersonGroupsBelongs(personId) : asyncInstance.getPersonGroupsBelongs(personId).get();
            }catch(Exception e){
                com.google.common.base.Throwables.throwIfUnchecked(e);
                throw new RuntimeException(e);
            }

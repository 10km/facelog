...
import static gu.dtalk.client.BaseCmdManager.parseValue;;
...
class DtalkCmd {
	 ...
	 * @return 收到命令的客户端数目
	 */
	int doRunCmd(List<Integer>target,boolean group,String cmdpath,Map<String, String>jsonArgs,String ackChannel,int id){
		...
		return cmdManager.runCmd(cmdpath, parseValue(jsonArgs));
	}
	/**
	 ...
	 */
	boolean doRunTask(String taskQueue,String cmdpath,Map<String, String>jsonArgs,String ackChannel,int id){

    ...
    public static abstract class  AbstractHandle <L,R>implements IBeanConverter<L, R> {
        ...
        private R[] makeRights(L[] lefts){
            ...
            for(int i=0;i<lefts.length;++i){
                rights[i]=null == lefts[i]?null:newInstanceR();
            }
            return rights;
        }
        private L[] makeLefts(R[] rights){
            ...
            for(int i=0;i<rights.length;++i){
                lefts[i]=null == rights[i]?null:newInstanceL();
            }
            return lefts;
        }
        private List<R> makeRights(List<L> lefts){
            ...
            for(int i=0;i<lefts.size();++i){
                rights.add (null == lefts.get(i)?null:newInstanceR());
            }
            return rights;
        }
        private List<L> makeLefts(List<R> rights){
            ...
            for(int i=0;i<rights.size();++i){
                lefts.add (null == rights.get(i)?null:newInstanceL());
            }
            return lefts;
        }
        @Override

...
// Generated on: 2019-05-26T04:56:42.461Z
...
public final class FeatureBean implements Struct {
  ...
  public String toString() {
    return "FeatureBean{_new=" + this._new + ", modified=" + this.modified + ", initialized=" + this.initialized + ", md5=" + this.md5 + ", sdkVersion=" + this.sdkVersion + ", personId=" + this.personId + ", feature=" + this.feature + ", updateTime=" + this.updateTime + "}";
  }
  ...
  private static final class FeatureBeanAdapter implements Adapter<FeatureBean, Builder> {
    ...
    public void write(Protocol protocol, FeatureBean struct) throws IOException {
      ...
      if (struct.sdkVersion != null) {
        protocol.writeFieldBegin("sdkVersion", 5, TType.STRING);

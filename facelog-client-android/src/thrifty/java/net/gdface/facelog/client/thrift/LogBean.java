...
// Generated on: 2019-08-07T06:20:26.753Z
  ...
  private static final class LogBeanAdapter implements Adapter<LogBean, Builder> {
    ...
    public void write(Protocol protocol, LogBean struct) throws IOException {
      ...
      if (struct.direction != null) {
        protocol.writeFieldBegin("direction", 11, TType.I32);
        protocol.writeI32(struct.direction);
        protocol.writeFieldEnd();
      }
      if (struct.verifyTime != null) {
        protocol.writeFieldBegin("verifyTime", 12, TType.I64);

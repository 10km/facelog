...
// Generated on: 2019-08-06T09:38:00.950Z
...
public final class PermitBean implements Struct {
  ...
  public boolean equals(Object other) {
    ...
    return (this._new == that._new || this._new.equals(that._new))
        ...
        && (this.limit == that.limit || (this.limit != null && this.limit.equals(that.limit)))
  ...
  public int hashCode() {
    ...
    code *= 0x811c9dc5;
    code ^= (this.limit == null) ? 0 : this.limit.hashCode();
    code *= 0x811c9dc5;
  ...
  public String toString() {
    return "PermitBean{_new=" + this._new + ", modified=" + this.modified + ", initialized=" + this.initialized + ", deviceGroupId=" + this.deviceGroupId + ", personGroupId=" + this.personGroupId + ", schedule=" + this.schedule + ", limit=" + this.limit + ", remark=" + this.remark + ", extBin=" + this.extBin + ", extTxt=" + this.extTxt + ", createTime=" + this.createTime + "}";
  }
  ...
  private static final class PermitBeanAdapter implements Adapter<PermitBean, Builder> {
    ...
    public void write(Protocol protocol, PermitBean struct) throws IOException {
      ...
      if (struct.limit != null) {
        protocol.writeFieldBegin("limit", 7, TType.STRING);
        protocol.writeString(struct.limit);
        protocol.writeFieldEnd();
      }

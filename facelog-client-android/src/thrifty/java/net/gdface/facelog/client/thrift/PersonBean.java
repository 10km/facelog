...
// Generated on: 2019-09-23T07:19:09.741Z
// Source: J:\facelog\facelog-service\IFaceLog.thrift at 155:1
...
public final class PersonBean implements Struct {
  ...
  public final Long activatedDate;
  ...
  public boolean equals(Object other) {
    ...
    return (this._new == that._new || this._new.equals(that._new))
        ...
        && (this.activatedDate == that.activatedDate || (this.activatedDate != null && this.activatedDate.equals(that.activatedDate)))
  ...
  public int hashCode() {
    ...
    code *= 0x811c9dc5;
    code ^= (this.activatedDate == null) ? 0 : this.activatedDate.hashCode();
    code *= 0x811c9dc5;
  ...
  public static final class Builder implements StructBuilder<PersonBean> {
    ...
    public Builder(PersonBean struct) {
      ...
      this.activatedDate = struct.activatedDate;
    ...
    public Builder activatedDate(Long activatedDate) {
  ...
  private static final class PersonBeanAdapter implements Adapter<PersonBean, Builder> {
    ...
    public void write(Protocol protocol, PersonBean struct) throws IOException {
      ...
      if (struct.activatedDate != null) {
        protocol.writeFieldBegin("activatedDate", 16, TType.I64);
        protocol.writeI64(struct.activatedDate);
        protocol.writeFieldEnd();
      }
      if (struct.remark != null) {
        protocol.writeFieldBegin("remark", 17, TType.STRING);
        protocol.writeString(struct.remark);
        protocol.writeFieldEnd();
      }
      if (struct.extBin != null) {
        protocol.writeFieldBegin("extBin", 18, TType.STRING);
        protocol.writeBinary(struct.extBin);
        protocol.writeFieldEnd();
      }
      if (struct.extTxt != null) {
        protocol.writeFieldBegin("extTxt", 19, TType.STRING);
        protocol.writeString(struct.extTxt);
        protocol.writeFieldEnd();
      }
      if (struct.createTime != null) {
        protocol.writeFieldBegin("createTime", 20, TType.I64);
        protocol.writeI64(struct.createTime);
        protocol.writeFieldEnd();
      }
      if (struct.updateTime != null) {
        protocol.writeFieldBegin("updateTime", 21, TType.I64);

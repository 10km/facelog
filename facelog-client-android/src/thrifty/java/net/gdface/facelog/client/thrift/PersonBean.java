...
// Generated on: 2019-01-23T04:51:25.021Z
// Source: J:\facelog\facelog-thriftservice\IFaceLog.thrift at 146:1
  ...
  private static final class PersonBeanAdapter implements Adapter<PersonBean, Builder> {
    ...
    public void write(Protocol protocol, PersonBean struct) throws IOException {
      ...
      if (struct.createTime != null) {
        protocol.writeFieldBegin("createTime", 17, TType.I64);
        protocol.writeI64(struct.createTime);
        protocol.writeFieldEnd();
      }
      if (struct.updateTime != null) {
        protocol.writeFieldBegin("updateTime", 18, TType.I64);

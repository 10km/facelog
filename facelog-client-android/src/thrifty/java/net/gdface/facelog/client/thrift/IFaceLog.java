...
public interface IFaceLog {
  ...
  void runCmd(List<Integer> target, Boolean group, String cmdpath, Map<String, String> jsonArgs,
      String ackChannel, Token token, ServiceMethodCallback<Integer> callback);

  void runTask(String taskQueue, String cmdpath, Map<String, String> jsonArgs, String ackChannel,

...
public interface IFaceLog {
  ...
  void applyCmdSn(Token token, ServiceMethodCallback<Integer> callback);
  ...
  void countPersonLog(Integer personId, Long startDate, Long endDate,
      ServiceMethodCallback<Map<String, Integer>> callback);

  void countPersonLogTimeStr(Integer personId, String startDate, String endDate,
      ServiceMethodCallback<Map<String, Integer>> callback);

  void deleteAllFeaturesByPersonId(Integer personId, Boolean deleteImage, Token token,
      ServiceMethodCallback<Integer> callback);

  void deleteDevice(Integer id, Token token, ServiceMethodCallback<Boolean> callback);

  void deleteDeviceByMac(String mac, Token token, ServiceMethodCallback<Boolean> callback);
  ...
  void getDeviceByMac(String mac, ServiceMethodCallback<DeviceBean> callback);
  ...
  void getFacesOfFeature(String featureMd5, ServiceMethodCallback<List<FaceBean>> callback);

  void getFacesOfImage(String imageMd5, ServiceMethodCallback<List<FaceBean>> callback);
  ...
  void getFeatures(List<String> md5List, ServiceMethodCallback<List<FeatureBean>> callback);

  void getFeaturesByPersonIdAndSdkVersion(Integer personId, String sdkVersion,
      ServiceMethodCallback<List<String>> callback);

  void getFeaturesOfImage(String imageMd5, ServiceMethodCallback<List<String>> callback);

  void getFeaturesOfPerson(Integer personId, ServiceMethodCallback<List<String>> callback);

  void getFeaturesPermittedOnDevice(Integer deviceId, Boolean ignoreSchedule, String sdkVersion,
      List<String> excludeFeatureIds, Long timestamp, ServiceMethodCallback<List<String>> callback);
  ...
  void getImageBytesRef(String primaryKey, String refType,
      ServiceMethodCallback<ByteString> callback);

  void getImageRef(String imageMD5, String refType, ServiceMethodCallback<ImageBean> callback);
  ...
  void getPersonByMobilePhone(String mobilePhone, ServiceMethodCallback<PersonBean> callback);

  void getPersonByMobilePhoneReal(String mobilePhone, Token token,
  ...
  void getPersonByPapersNumReal(String papersNum, Token token,
      ServiceMethodCallback<PersonBean> callback);
  ...
  void getPersonReal(Integer personId, Token token, ServiceMethodCallback<PersonBean> callback);
  ...
  void getPersonsPermittedOnDevice(Integer deviceId, Boolean ignoreSchedule,
      List<Integer> excludePersonIds, Long timestamp,
      ServiceMethodCallback<List<Integer>> callback);

  void getPersonsReal(List<Integer> idList, Token token,
      ServiceMethodCallback<List<PersonBean>> callback);

  void getProperties(String prefix, Token token,
  ...
  void isValidCmdSn(Integer cmdSn, ServiceMethodCallback<Boolean> callback);
  ...
  void loadDistinctIntegerColumn(String table, String column, String where,
      ServiceMethodCallback<List<Integer>> callback);

  void loadDistinctStringColumn(String table, String column, String where,
      ServiceMethodCallback<List<String>> callback);
  ...
  void loadPersonByWhereReal(String where, Integer startRow, Integer numRows, Token token,
      ServiceMethodCallback<List<PersonBean>> callback);
  ...
  void runCmd(List<Integer> target, Boolean group, String cmdpath, String jsonArgs,
      String ackChannel, Token token, ServiceMethodCallback<String> callback);

  void runTask(String taskQueue, String cmdpath, String jsonArgs, String ackChannel, Token token,
      ServiceMethodCallback<Integer> callback);
  ...
  void savePermit(PermitBean permitBean, Token token, ServiceMethodCallback<PermitBean> callback);

  void savePermitWithColumn(Integer deviceGroupId, Integer personGroupId, String column,
  ...
  void savePersonsWithPhoto(List<ByteString> photos, List<PersonBean> persons, Token token,
      ServiceMethodCallback<Integer> callback);

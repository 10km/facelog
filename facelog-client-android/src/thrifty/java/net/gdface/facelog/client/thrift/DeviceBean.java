...
// Generated on: 2019-03-28T01:23:57.808Z
...
public final class DeviceBean implements Struct {
  ...
  public String toString() {
    return "DeviceBean{_new=" + this._new + ", modified=" + this.modified + ", initialized=" + this.initialized + ", id=" + this.id + ", groupId=" + this.groupId + ", name=" + this.name + ", version=" + this.version + ", serialNo=" + this.serialNo + ", mac=" + this.mac + ", remark=" + this.remark + ", extBin=" + this.extBin + ", extTxt=" + this.extTxt + ", createTime=" + this.createTime + ", updateTime=" + this.updateTime + "}";
  }

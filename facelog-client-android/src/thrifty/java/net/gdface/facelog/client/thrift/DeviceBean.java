...
// Generated on: 2019-05-14T07:14:18.125Z
// Source: J:\facelog\facelog-service\IFaceLog.thrift at 130:1
  ...
  private static final class DeviceBeanAdapter implements Adapter<DeviceBean, Builder> {
    ...
    public void write(Protocol protocol, DeviceBean struct) throws IOException {
      ...
      if (struct.serialNo != null) {
        protocol.writeFieldBegin("serialNo", 13, TType.STRING);
        protocol.writeString(struct.serialNo);
        protocol.writeFieldEnd();
      }
      if (struct.mac != null) {
        protocol.writeFieldBegin("mac", 14, TType.STRING);
        protocol.writeString(struct.mac);
        protocol.writeFieldEnd();
      }
      if (struct.remark != null) {
        protocol.writeFieldBegin("remark", 15, TType.STRING);
        protocol.writeString(struct.remark);
        protocol.writeFieldEnd();
      }
      if (struct.extBin != null) {
        protocol.writeFieldBegin("extBin", 16, TType.STRING);
        protocol.writeBinary(struct.extBin);
        protocol.writeFieldEnd();
      }
      if (struct.extTxt != null) {
        protocol.writeFieldBegin("extTxt", 17, TType.STRING);
        protocol.writeString(struct.extTxt);
        protocol.writeFieldEnd();
      }
      if (struct.createTime != null) {
        protocol.writeFieldBegin("createTime", 18, TType.I64);
        protocol.writeI64(struct.createTime);
        protocol.writeFieldEnd();
      }
      if (struct.updateTime != null) {
        protocol.writeFieldBegin("updateTime", 19, TType.I64);

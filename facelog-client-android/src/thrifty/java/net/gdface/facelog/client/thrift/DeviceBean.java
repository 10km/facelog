...
// Generated on: 2019-05-26T09:14:59.973Z
// Source: J:\facelog\facelog-service\IFaceLog.thrift at 131:1
...
public final class DeviceBean implements Struct {
  ...
  public boolean equals(Object other) {
    ...
    return (this._new == that._new || this._new.equals(that._new))
        ...
        && (this.sdkVersion == that.sdkVersion || (this.sdkVersion != null && this.sdkVersion.equals(that.sdkVersion)))
  ...
  public int hashCode() {
    ...
    code *= 0x811c9dc5;
    code ^= (this.sdkVersion == null) ? 0 : this.sdkVersion.hashCode();
    code *= 0x811c9dc5;
  ...
  public static final class Builder implements StructBuilder<DeviceBean> {
    ...
    public Builder(DeviceBean struct) {
      ...
      this.sdkVersion = struct.sdkVersion;
  ...
  private static final class DeviceBeanAdapter implements Adapter<DeviceBean, Builder> {
    ...
    public void write(Protocol protocol, DeviceBean struct) throws IOException {
      ...
      if (struct.sdkVersion != null) {
        protocol.writeFieldBegin("sdkVersion", 13, TType.STRING);
        protocol.writeString(struct.sdkVersion);
        protocol.writeFieldEnd();
      }

...
// Generated on: 2019-01-23T04:51:25.024Z
// Source: J:\facelog\facelog-thriftservice\IFaceLog.thrift at 191:1
...
public final class Token implements Struct {
  ...
  public String toString() {
    return "Token{id=" + this.id + ", t1=" + this.t1 + ", t2=" + this.t2 + ", type=" + this.type + "}";
  }
  ...
  private static final class TokenAdapter implements Adapter<Token, Builder> {
    ...
    public void write(Protocol protocol, Token struct) throws IOException {
      ...
      protocol.writeFieldBegin("t1", 2, TType.I64);
      protocol.writeI64(struct.t1);
      protocol.writeFieldEnd();
      protocol.writeFieldBegin("t2", 3, TType.I64);
      protocol.writeI64(struct.t2);
      protocol.writeFieldEnd();
      if (struct.type != null) {
        protocol.writeFieldBegin("type", 4, TType.I32);

...
// Generated on: 2019-08-28T07:25:01.164Z
// Source: J:\facelog\facelog-service\IFaceLog.thrift at 195:1
...
public final class LogLightBean implements Struct {
  ...
  public boolean equals(Object other) {
    ...
    return (this._new == that._new || this._new.equals(that._new))
        ...
        && (this.direction == that.direction || (this.direction != null && this.direction.equals(that.direction)));
  }
  ...
  public int hashCode() {
    ...
    code *= 0x811c9dc5;
    code ^= (this.direction == null) ? 0 : this.direction.hashCode();
    code *= 0x811c9dc5;
    return code;
  }
  ...
  public String toString() {
    return "LogLightBean{_new=" + this._new + ", modified=" + this.modified + ", initialized=" + this.initialized + ", id=" + this.id + ", personId=" + this.personId + ", name=" + this.name + ", papersType=" + this.papersType + ", papersNum=" + this.papersNum + ", verifyTime=" + this.verifyTime + ", direction=" + this.direction + "}";
  }
  ...
  private static final class LogLightBeanAdapter implements Adapter<LogLightBean, Builder> {
    ...
    public void write(Protocol protocol, LogLightBean struct) throws IOException {
      ...
      if (struct.direction != null) {
        protocol.writeFieldBegin("direction", 10, TType.I32);
        protocol.writeI32(struct.direction);
        protocol.writeFieldEnd();
      }

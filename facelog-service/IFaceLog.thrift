...
service IFaceLog {
  FeatureBean addFeature(1:  binary feature, 2: optional i32 personId, 3:  list<FaceBean> faecBeans, 4:  Token token) throws (1: ServiceRuntimeException ex1, 2: DuplicateRecordException ex2);
  FeatureBean addFeatureMulti(1:  binary feature, 2: optional i32 personId, 3:  map<binary, FaceBean> faceInfo, 4: optional i32 deviceId, 5:  Token token) throws (1: ServiceRuntimeException ex1, 2: DuplicateRecordException ex2);
  ImageBean addImage(1:  binary imageData, 2: optional i32 deviceId, 3:  FaceBean faceBean, 4: optional i32 personId, 5:  Token token) throws (1: ServiceRuntimeException ex1, 2: DuplicateRecordException ex2);
  ...
  Token applyPersonToken(1: required i32 personId, 2:  string password, 3: required bool isMd5) throws (1: ServiceRuntimeException ex1, 2: ServiceSecurityException ex2);
  Token applyRootToken(1:  string password, 2: required bool isMd5) throws (1: ServiceRuntimeException ex1, 2: ServiceSecurityException ex2);
  ...
  bool isValidPassword(1:  string userId, 2:  string password, 3: required bool isMd5, 4:  Token token) throws (1: ServiceRuntimeException ex1, 2: ServiceSecurityException ex2);

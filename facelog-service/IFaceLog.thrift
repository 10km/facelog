...
service IFaceLog {
  ...
  i32 runCmd(1: optional list<i32> target, 2: required bool group, 3: optional string cmdpath, 4: optional map<string, string> jsonArgs, 5: optional string ackChannel, 6: optional Token token) throws (1: ServiceRuntimeException ex1);
  bool runTask(1: optional string taskQueue, 2: optional string cmdpath, 3: optional map<string, string> jsonArgs, 4: optional string ackChannel, 5: optional Token token) throws (1: ServiceRuntimeException ex1);

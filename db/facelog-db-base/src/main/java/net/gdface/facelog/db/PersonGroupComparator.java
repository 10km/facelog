...
public class PersonGroupComparator implements Comparator<PersonGroupBean>,Constant
{
    ...
    /**
     * Constructor class for PersonGroupComparator.
     * <br>
     * Example:
     * <br>
     * <code>Arrays.sort(pArray, new PersonGroupComparator(Constant.FL_PERSON_GROUP_ID_ID, bReverse));</code>
     *
     ...
     * </ul>
     */
    public PersonGroupComparator(int iType)
    {
        this(iType, false);
    }
     ...
     */
    public PersonGroupComparator(int iType, boolean bReverse)
    {
        this.iType = iType;
    ...
    @Override
    public int compare(PersonGroupBean b1, PersonGroupBean b2)
    {
        int iReturn = 0;
        switch(iType)
        {

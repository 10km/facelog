...
public class FaceComparator implements Comparator<FaceBean>,Constant
{
    ...
    /**
     * Constructor class for FaceComparator.
     * <br>
     * Example:
     * <br>
     * <code>Arrays.sort(pArray, new FaceComparator(Constant.FL_FACE_ID_ID, bReverse));</code>
     *
     ...
     * </ul>
     */
    public FaceComparator(int iType)
    {
        this(iType, false);
    }
     ...
     */
    public FaceComparator(int iType, boolean bReverse)
    {
        this.iType = iType;
    ...
    @Override
    public int compare(FaceBean b1, FaceBean b2)
    {
        int iReturn = 0;
        switch(iType)
        {

...
public class DeviceGroupComparator implements Comparator<DeviceGroupBean>,Constant
{
    ...
    /**
     * Constructor class for DeviceGroupComparator.
     * <br>
     * Example:
     * <br>
     * <code>Arrays.sort(pArray, new DeviceGroupComparator(Constant.FL_DEVICE_GROUP_ID_ID, bReverse));</code>
     *
     ...
     *   <li>{@link Constant#FL_DEVICE_GROUP_ID_CREATE_TIME}
     *   <li>{@link Constant#FL_DEVICE_GROUP_ID_UPDATE_TIME}
     * </ul>
     */
    public DeviceGroupComparator(int iType)
    {
        this(iType, false);
    }
     ...
     */
    public DeviceGroupComparator(int iType, boolean bReverse)
    {
        this.iType = iType;
    ...
    @Override
    public int compare(DeviceGroupBean b1, DeviceGroupBean b2)
    {
        int iReturn = 0;
        switch(iType)
        {

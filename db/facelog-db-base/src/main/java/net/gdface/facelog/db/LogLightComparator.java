...
public class LogLightComparator implements Comparator<LogLightBean>,Constant
{
    ...
    /**
     * Constructor class for LogLightComparator.
     * <br>
     * Example:
     * <br>
     * <code>Arrays.sort(pArray, new LogLightComparator(Constant.FL_LOG_LIGHT_ID_ID, bReverse));</code>
     *
     ...
     */
    public LogLightComparator(int iType, boolean bReverse)
    {
        this.iType = iType;
    ...
    @Override
    public int compare(LogLightBean b1, LogLightBean b2)
    {
        int iReturn = 0;
        switch(iType)
        {

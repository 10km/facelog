    ...
    implements Serializable,BaseBean<DeviceGroupBean>,Comparable<DeviceGroupBean>,Constant,Cloneable
{
    ...
    /** comments:设备组id */
    @ApiModelProperty(value = "设备组id" ,required=true ,dataType="$strUtil.simpleName($column.javaType)")
    private Integer id;

    /** comments:设备组名 */
    @ApiModelProperty(value = "设备组名" ,required=true ,dataType="$strUtil.simpleName($column.javaType)")
    private String name;
    ...
    /** comments:上一级设备组id */
    @ApiModelProperty(value = "上一级设备组id"  ,dataType="$strUtil.simpleName($column.javaType)")
    private Integer parent;

    /** comments:指向人员组id,用于应用层定义管理员/操作员的管理边界,此字段不为null代表此设备组为管理边界,指向的人员组为此设备组的拥有者的顶级组 */
    @ApiModelProperty(value = "指向人员组id,用于应用层定义管理员/操作员的管理边界,此字段不为null代表此设备组为管理边界,指向的人员组为此设备组的拥有者的顶级组"  ,dataType="$strUtil.simpleName($column.javaType)")
     ...
     * @return {@code this} 
     */
    private DeviceGroupBean immutable(Boolean immutable) {

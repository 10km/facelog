...
public class PersonComparator implements Comparator<PersonBean>,Constant
{
    ...
    /**
     * Constructor class for PersonComparator.
     * <br>
     * Example:
     * <br>
     * <code>Arrays.sort(pArray, new PersonComparator(Constant.FL_PERSON_ID_ID, bReverse));</code>
     *
     ...
     * </ul>
     */
    public PersonComparator(int iType)
    {
        this(iType, false);
    }
     ...
     */
    public PersonComparator(int iType, boolean bReverse)
    {
        this.iType = iType;
    ...
    @Override
    public int compare(PersonBean b1, PersonBean b2)
    {
        int iReturn = 0;
        switch(iType)
        {

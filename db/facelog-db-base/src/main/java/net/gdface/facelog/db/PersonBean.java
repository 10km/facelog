    ...
    implements Serializable,BaseBean<PersonBean>,Comparable<PersonBean>,Constant,Cloneable
{
     ...
     */
    @ThriftField(name = "activatedDate",value = 16)
    ...
    public void writeActivatedDate(Long newVal){
        checkMutable();
        activatedDate = null == newVal?null:new java.util.Date(newVal);
    }
    /**
     * Setter method for {@link #activatedDate}.<br>
     * Convenient for those who do not want to deal with Objects for primary types.
    ...
    public static String columnNameOf(int columnId){
        try{
            return FL_PERSON_FIELDS_LIST.get(columnId);
    ...
    public static Class<?> typeOf(int columnId){
        try{
            return FL_PERSON_FIELD_TYPES[columnId];
        } catch(IndexOutOfBoundsException e){
            return null;
        }
    }

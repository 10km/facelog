 ...
 * @author guyadong
 */
public class LogLightManager implements TableManager<LogLightBean>
{
    ...
    */
     ...
     * @return the saved {@link LogLightBean} beans or null if beans is null.
     */
    //15
    ...
    //20-3
    @Override
    public LogLightBean[] loadUsingTemplate(LogLightBean bean, int startRow, int numRows, SearchType searchType)
    {
    ...
    //20-4
    @Override
    public List<LogLightBean> loadUsingTemplateAsList(LogLightBean bean, int startRow, int numRows, SearchType searchType)
    {
        try{
    ...
    //20-5
    @Override
    public int loadUsingTemplate(LogLightBean bean, int[] fieldList, int startRow, int numRows,SearchType searchType, Action<LogLightBean> action)
    {
        try {
    ...
    //20
    @Override
    public int countUsingTemplate(LogLightBean bean, int startRow, int numRows, SearchType searchType)
    {
        try{

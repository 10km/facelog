...
public interface TableManager<B1 extends BaseBean<?>,B2 extends FullBean<B1>> {
    ...
    public abstract <C extends Collection<B2>> C insert(C beans) throws DAOException;

    public abstract B2[] insertAsTransaction(B2[] beans) throws DAOException;

    public abstract <C extends Collection<B2>> C insertAsTransaction(C beans) throws DAOException;
    ...
    public abstract void registerListener(TableListener<B2> listener);

    public abstract B2 save(B2 bean) throws DAOException;

    public abstract B2[] save(B2[] beans) throws DAOException;

    public abstract <C extends Collection<B2>> C saveAsTransaction(C beans) throws DAOException;

    public abstract B2[] saveAsTransaction(B2[] beans) throws DAOException;

    public abstract <C extends Collection<B2>> C save(C beans) throws DAOException;

    public abstract B2 update(B2 bean) throws DAOException;

    public abstract B2[] update(B2[] beans) throws DAOException;

    public abstract <C extends Collection<B2>> C update(C beans) throws DAOException;
    
    public abstract B2[] updateAsTransaction(B2[] beans) throws DAOException;

    public abstract <C extends Collection<B2>> C updateAsTransaction(C beans) throws DAOException;
    ...
    public <C extends Collection<?>> C setImportedBeans(B2 bean,C importedBeans,String fkName)throws DAOException;
}

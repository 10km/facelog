...
{
	private static final long serialVersionUID = 6195423399972248469L;
    ...
    /**
     * Prefered methods to create a FlFaceLightBean is via the createFlFaceLightBean method in FlFaceLightManager or
     ...
     */
    FlFaceLightBean(FlFaceLightBeanBase bean){
        super();
        copy(bean);
    }
    /**

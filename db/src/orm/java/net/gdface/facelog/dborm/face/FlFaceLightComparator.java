 ...
 * @author sql2java
 */
public class FlFaceLightComparator implements Comparator
{
    /**
    ...
    /**
     * Constructor class for FlFaceLightComparator.
     * <br>
     * Example:
     * <br>
     * <code>Arrays.sort(pArray, new FlFaceLightComparator(FlFaceLightManager.ID_CREATE_TIME, bReverse));<code>
     *
     ...
     */
    public FlFaceLightComparator(int iType, boolean bReverse)
    {
        this.iType = iType;
    ...
    {
        FlFaceLightBean b1 = (FlFaceLightBean)pObj1;
        FlFaceLightBean b2 = (FlFaceLightBean)pObj2;
        int iReturn = 0;
        switch(iType)
        {

...
// Generated on: 2019-01-23T03:13:59.427Z
// Source: J:\facelog\facelog-thriftservice\IFaceLog.thrift at 113:1
...
public final class PersonGroupBean implements Struct {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PersonGroupBean)) return false;
    PersonGroupBean that = (PersonGroupBean) other;
  ...
  public String toString() {
    return "PersonGroupBean{_new=" + this._new + ", modified=" + this.modified + ", initialized=" + this.initialized + ", id=" + this.id + ", name=" + this.name + ", leaf=" + this.leaf + ", parent=" + this.parent + ", remark=" + this.remark + ", extBin=" + this.extBin + ", extTxt=" + this.extTxt + ", createTime=" + this.createTime + ", updateTime=" + this.updateTime + "}";
  }
  ...
  public static final class Builder implements StructBuilder<PersonGroupBean> {
    ...
    public Builder(PersonGroupBean struct) {
  ...
  private static final class PersonGroupBeanAdapter implements Adapter<PersonGroupBean, Builder> {
    @Override
    public void write(Protocol protocol, PersonGroupBean struct) throws IOException {
    ...
    @Override
    public PersonGroupBean read(Protocol protocol) throws IOException {

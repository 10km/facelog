...
// Generated on: 2019-01-23T03:13:59.425Z
// Source: J:\facelog\facelog-thriftservice\IFaceLog.thrift at 98:1
...
public final class DeviceGroupBean implements Struct {
  ...
  public String toString() {
    return "DeviceGroupBean{_new=" + this._new + ", modified=" + this.modified + ", initialized=" + this.initialized + ", id=" + this.id + ", name=" + this.name + ", leaf=" + this.leaf + ", parent=" + this.parent + ", remark=" + this.remark + ", extBin=" + this.extBin + ", extTxt=" + this.extTxt + ", createTime=" + this.createTime + ", updateTime=" + this.updateTime + "}";
  }

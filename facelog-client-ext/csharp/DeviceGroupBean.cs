...
[Serializable]
#endif
public partial class DeviceGroupBean : TBase
{
  ...
  public DeviceGroupBean(bool _new, long modified, long initialized) : this() {
    this._new = _new;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("DeviceGroupBean");
      ...
      if (Parent != null) {
        ...
        field.ID = 7;
        oprot.WriteFieldBegin(field);
        oprot.WriteI32(Parent.Value);
        oprot.WriteFieldEnd();
      }
      if (RootGroup != null) {
        field.Name = "rootGroup";
        field.Type = TType.I32;
        field.ID = 8;
        oprot.WriteFieldBegin(field);
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("DeviceGroupBean(");
    __sb.Append(", _new: ");
    __sb.Append(_new);

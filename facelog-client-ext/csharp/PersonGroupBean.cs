...
[Serializable]
#endif
public partial class PersonGroupBean : TBase
{
  ...
  public PersonGroupBean(bool _new, long modified, long initialized) : this() {
    this._new = _new;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("PersonGroupBean");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("PersonGroupBean(");
    __sb.Append(", _new: ");
    __sb.Append(_new);

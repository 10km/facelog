...
class IFaceLogIf {
 public:
  ...
  virtual int32_t runCmd(const std::vector<int32_t> & target, const bool group, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token) = 0;
  virtual bool runTask(const std::string& taskQueue, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token) = 0;
  ...
  virtual void savePersonFull(PersonBean& _return, const PersonBean& personBean, const std::string& idPhoto, const std::string& feature, const std::string& featureVersion, const std::string& featureImage, const FaceBean& featureFaceBean, const Token& token) = 0;
...
class IFaceLogNull : virtual public IFaceLogIf {
 public:
  ...
  void getFeaturesByPersonId(std::vector<std::string> & /* _return */, const int32_t /* personId */) {
    return;
  }
  ...
  int32_t runCmd(const std::vector<int32_t> & /* target */, const bool /* group */, const std::string& /* cmdpath */, const std::map<std::string, std::string> & /* jsonArgs */, const std::string& /* ackChannel */, const Token& /* token */) {
    int32_t _return = 0;
    return _return;
  }
  bool runTask(const std::string& /* taskQueue */, const std::string& /* cmdpath */, const std::map<std::string, std::string> & /* jsonArgs */, const std::string& /* ackChannel */, const Token& /* token */) {
    bool _return = false;
    return _return;
  }
  ...
  void savePersonFull(PersonBean& /* _return */, const PersonBean& /* personBean */, const std::string& /* idPhoto */, const std::string& /* feature */, const std::string& /* featureVersion */, const std::string& /* featureImage */, const FaceBean& /* featureFaceBean */, const Token& /* token */) {
    return;
  }
...
typedef struct _IFaceLog_addFeature_args__isset {
  _IFaceLog_addFeature_args__isset() : feature(false), featureVersion(false), personId(false), faecBeans(false), token(false) {}
  bool feature :1;
...
class IFaceLog_addFeature_args {
 public:
  ...
  IFaceLog_addFeature_args() : feature(), featureVersion(), personId(0) {
  }
...
class IFaceLog_addFeatureMulti_args {
 public:
  ...
  IFaceLog_addFeatureMulti_args() : feature(), featureVersion(), personId(0) {
  }
...
typedef struct _IFaceLog_addFeatureWithImage_args__isset {
  _IFaceLog_addFeatureWithImage_args__isset() : feature(false), featureVersion(false), personId(false), featurePhoto(false), faceBean(false), token(false) {}
  bool feature :1;
  bool featureVersion :1;
  bool personId :1;
  bool featurePhoto :1;
...
class IFaceLog_addFeatureWithImage_args {
 public:
  ...
  IFaceLog_addFeatureWithImage_args() : feature(), featureVersion(), personId(0), asIdPhotoIfAbsent(0), featurePhoto() {
  }
...
class IFaceLog_getFeaturesByPersonId_args {
 public:

  IFaceLog_getFeaturesByPersonId_args(const IFaceLog_getFeaturesByPersonId_args&);
  IFaceLog_getFeaturesByPersonId_args(IFaceLog_getFeaturesByPersonId_args&&);
  IFaceLog_getFeaturesByPersonId_args& operator=(const IFaceLog_getFeaturesByPersonId_args&);
  IFaceLog_getFeaturesByPersonId_args& operator=(IFaceLog_getFeaturesByPersonId_args&&);
  IFaceLog_getFeaturesByPersonId_args() : personId(0) {
  }

  virtual ~IFaceLog_getFeaturesByPersonId_args() throw();
  int32_t personId;

  void __set_personId(const int32_t val);

  bool operator == (const IFaceLog_getFeaturesByPersonId_args & rhs) const
  {
    if (!(personId == rhs.personId))
      return false;
    return true;
  ...
  bool operator < (const IFaceLog_getFeaturesByPersonId_args & ) const;
...
class IFaceLog_getFeaturesByPersonId_pargs {
 public:


  virtual ~IFaceLog_getFeaturesByPersonId_pargs() throw();
  const int32_t* personId;
...
typedef struct _IFaceLog_getFeaturesByPersonId_result__isset {
  _IFaceLog_getFeaturesByPersonId_result__isset() : success(false), ex1(false) {}
  bool success :1;
  bool ex1 :1;
} _IFaceLog_getFeaturesByPersonId_result__isset;

class IFaceLog_getFeaturesByPersonId_result {
 public:

  IFaceLog_getFeaturesByPersonId_result(const IFaceLog_getFeaturesByPersonId_result&);
  IFaceLog_getFeaturesByPersonId_result(IFaceLog_getFeaturesByPersonId_result&&);
  IFaceLog_getFeaturesByPersonId_result& operator=(const IFaceLog_getFeaturesByPersonId_result&);
  IFaceLog_getFeaturesByPersonId_result& operator=(IFaceLog_getFeaturesByPersonId_result&&);
  IFaceLog_getFeaturesByPersonId_result() {
  }

  virtual ~IFaceLog_getFeaturesByPersonId_result() throw();
  std::vector<std::string>  success;
  ServiceRuntimeException ex1;

  _IFaceLog_getFeaturesByPersonId_result__isset __isset;

  void __set_success(const std::vector<std::string> & val);

  void __set_ex1(const ServiceRuntimeException& val);

  bool operator == (const IFaceLog_getFeaturesByPersonId_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(ex1 == rhs.ex1))
  ...
  bool operator < (const IFaceLog_getFeaturesByPersonId_result & ) const;
...
typedef struct _IFaceLog_getFeaturesByPersonId_presult__isset {
  _IFaceLog_getFeaturesByPersonId_presult__isset() : success(false), ex1(false) {}
  bool success :1;
  bool ex1 :1;
} _IFaceLog_getFeaturesByPersonId_presult__isset;

class IFaceLog_getFeaturesByPersonId_presult {
 public:


  virtual ~IFaceLog_getFeaturesByPersonId_presult() throw();
  std::vector<std::string> * success;
  ServiceRuntimeException ex1;

  _IFaceLog_getFeaturesByPersonId_presult__isset __isset;
...
class IFaceLog_runCmd_args {
 public:
  ...
  IFaceLog_runCmd_args() : group(0), cmdpath(), ackChannel() {
  }
  ...
  bool group;
  std::string cmdpath;
  std::map<std::string, std::string>  jsonArgs;
  std::string ackChannel;
  Token token;
  ...
  void __set_jsonArgs(const std::map<std::string, std::string> & val);
...
class IFaceLog_runCmd_pargs {
 public:
  ...
  const std::map<std::string, std::string> * jsonArgs;
  const std::string* ackChannel;
  const Token* token;
...
class IFaceLog_runTask_args {
 public:
  ...
  IFaceLog_runTask_args() : taskQueue(), cmdpath(), ackChannel() {
  }
...
typedef struct _IFaceLog_savePersonFull_args__isset {
  _IFaceLog_savePersonFull_args__isset() : personBean(false), idPhoto(false), feature(false), featureVersion(false), featureImage(false), featureFaceBean(false), token(false) {}
  bool personBean :1;
  bool idPhoto :1;
  bool feature :1;
  bool featureVersion :1;
  bool featureImage :1;
  bool featureFaceBean :1;
  bool token :1;
...
class IFaceLog_savePersonFull_args {
 public:
  ...
  void __set_featureFaceBean(const FaceBean& val);
  ...
  bool operator == (const IFaceLog_savePersonFull_args & rhs) const
  {
    ...
    if (!(featureImage == rhs.featureImage))
      return false;
    if (!(featureFaceBean == rhs.featureFaceBean))
      return false;
    if (!(token == rhs.token))
      return false;
    return true;
...
class IFaceLog_savePersonFull_pargs {
 public:
  ...
  const std::string* featureVersion;
  const std::string* featureImage;
  const FaceBean* featureFaceBean;
  const Token* token;
...
class IFaceLogClientT : virtual public IFaceLogIf {
 ...
 public:
  ...
  void getFeaturesByPersonId(std::vector<std::string> & _return, const int32_t personId);
  void send_getFeaturesByPersonId(const int32_t personId);
  void recv_getFeaturesByPersonId(std::vector<std::string> & _return);
  void getFeaturesByPersonIdAndSdkVersion(std::vector<std::string> & _return, const int32_t personId, const std::string& sdkVersion);
  ...
  int32_t runCmd(const std::vector<int32_t> & target, const bool group, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  void send_runCmd(const std::vector<int32_t> & target, const bool group, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  int32_t recv_runCmd();
  bool runTask(const std::string& taskQueue, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  void send_runTask(const std::string& taskQueue, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  bool recv_runTask();
  void saveDevice(DeviceBean& _return, const DeviceBean& deviceBean, const Token& token);
  ...
  void savePersonFull(PersonBean& _return, const PersonBean& personBean, const std::string& idPhoto, const std::string& feature, const std::string& featureVersion, const std::string& featureImage, const FaceBean& featureFaceBean, const Token& token);
  void send_savePersonFull(const PersonBean& personBean, const std::string& idPhoto, const std::string& feature, const std::string& featureVersion, const std::string& featureImage, const FaceBean& featureFaceBean, const Token& token);
...
class IFaceLogProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 private:
  ...
  void process_getFeaturesByPersonId(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_getFeaturesByPersonId(int32_t seqid, Protocol_* iprot, Protocol_* oprot, void* callContext);
 ...
 public:
  IFaceLogProcessorT(::apache::thrift::stdcxx::shared_ptr<IFaceLogIf> iface) :
    ...
    processMap_["getFeatures"] = ProcessFunctions(
      ...
      &IFaceLogProcessorT::process_getFeatures);
    processMap_["getFeaturesByPersonId"] = ProcessFunctions(
      &IFaceLogProcessorT::process_getFeaturesByPersonId,
      &IFaceLogProcessorT::process_getFeaturesByPersonId);
...
class IFaceLogMultiface : virtual public IFaceLogIf {
 ...
 public:
  void addFeature(FeatureBean& _return, const std::string& feature, const std::string& featureVersion, const int32_t personId, const std::vector<FaceBean> & faecBeans, const Token& token) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->addFeature(_return, feature, featureVersion, personId, faecBeans, token);
    }
    ifaces_[i]->addFeature(_return, feature, featureVersion, personId, faecBeans, token);
    return;
  }
  ...
  void addFeatureWithImage(FeatureBean& _return, const std::string& feature, const std::string& featureVersion, const int32_t personId, const bool asIdPhotoIfAbsent, const std::string& featurePhoto, const FaceBean& faceBean, const Token& token) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->addFeatureWithImage(_return, feature, featureVersion, personId, asIdPhotoIfAbsent, featurePhoto, faceBean, token);
    }
    ifaces_[i]->addFeatureWithImage(_return, feature, featureVersion, personId, asIdPhotoIfAbsent, featurePhoto, faceBean, token);
    return;
  }
  ...
  void getFeaturesByPersonId(std::vector<std::string> & _return, const int32_t personId) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->getFeaturesByPersonId(_return, personId);
    }
    ifaces_[i]->getFeaturesByPersonId(_return, personId);
    return;
  }
  ...
  void savePersonFull(PersonBean& _return, const PersonBean& personBean, const std::string& idPhoto, const std::string& feature, const std::string& featureVersion, const std::string& featureImage, const FaceBean& featureFaceBean, const Token& token) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->savePersonFull(_return, personBean, idPhoto, feature, featureVersion, featureImage, featureFaceBean, token);
    }
    ifaces_[i]->savePersonFull(_return, personBean, idPhoto, feature, featureVersion, featureImage, featureFaceBean, token);
    return;
  }
...
class IFaceLogConcurrentClientT : virtual public IFaceLogIf {
 ...
 public:
  ...
  void getFeaturesByPersonId(std::vector<std::string> & _return, const int32_t personId);
  int32_t send_getFeaturesByPersonId(const int32_t personId);
  void recv_getFeaturesByPersonId(std::vector<std::string> & _return, const int32_t seqid);
  void getFeaturesByPersonIdAndSdkVersion(std::vector<std::string> & _return, const int32_t personId, const std::string& sdkVersion);
  ...
  int32_t runCmd(const std::vector<int32_t> & target, const bool group, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  int32_t send_runCmd(const std::vector<int32_t> & target, const bool group, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  int32_t recv_runCmd(const int32_t seqid);
  bool runTask(const std::string& taskQueue, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  int32_t send_runTask(const std::string& taskQueue, const std::string& cmdpath, const std::map<std::string, std::string> & jsonArgs, const std::string& ackChannel, const Token& token);
  ...
  void savePersonFull(PersonBean& _return, const PersonBean& personBean, const std::string& idPhoto, const std::string& feature, const std::string& featureVersion, const std::string& featureImage, const FaceBean& featureFaceBean, const Token& token);
  int32_t send_savePersonFull(const PersonBean& personBean, const std::string& idPhoto, const std::string& feature, const std::string& featureVersion, const std::string& featureImage, const FaceBean& featureFaceBean, const Token& token);

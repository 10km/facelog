  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.I64) {
        this.modified = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 3:
      if (ftype == Thrift.Type.I64) {
        this.initialized = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 6:
      if (ftype == Thrift.Type.I32) {
        this.faceLeft = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 7:
      if (ftype == Thrift.Type.I32) {
        this.faceTop = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 8:
      if (ftype == Thrift.Type.I32) {
        this.faceWidth = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 9:
      if (ftype == Thrift.Type.I32) {
        this.faceHeight = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 10:
      if (ftype == Thrift.Type.I32) {
        this.eyeLeftx = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 11:
      if (ftype == Thrift.Type.I32) {
        this.eyeLefty = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 12:
      if (ftype == Thrift.Type.I32) {
        this.eyeRightx = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 13:
      if (ftype == Thrift.Type.I32) {
        this.eyeRighty = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 14:
      if (ftype == Thrift.Type.I32) {
        this.mouthX = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 15:
      if (ftype == Thrift.Type.I32) {
        this.mouthY = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 16:
      if (ftype == Thrift.Type.I32) {
        this.noseX = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 17:
      if (ftype == Thrift.Type.I32) {
        this.noseY = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 18:
      if (ftype == Thrift.Type.I32) {
        this.angleYaw = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 19:
      if (ftype == Thrift.Type.I32) {
        this.anglePitch = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 20:
      if (ftype == Thrift.Type.I32) {
        this.angleRoll = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 21:
      if (ftype == Thrift.Type.STRING) {
        this.extInfo = input.readBinary().value;
      } else {
        input.skip(ftype);
      }
      break;
...
DuplicateRecordException = function(args) {
  this.message = null;
...
DuplicateRecordException.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.causeClass = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.serviceStackTraceMessage = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.causeFields = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ServiceRuntimeException = function(args) {
  this.message = null;
  this.causeClass = null;
  this.serviceStackTraceMessage = null;
  this.causeFields = null;
...
ImageBean.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 10:
      if (ftype == Thrift.Type.STRING) {
        this.thumbMd5 = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
LogBean.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 7:
      if (ftype == Thrift.Type.STRING) {
        this.verifyFeature = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 8:
      if (ftype == Thrift.Type.I32) {
        this.compareFace = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 9:
      if (ftype == Thrift.Type.I32) {
        this.verifyStatus = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
DeviceBean.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 11:
      if (ftype == Thrift.Type.I64) {
        this.madeDate = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
...
PersonBean.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 12:
      if (ftype == Thrift.Type.I32) {
        this.papersType = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
PermitBean.prototype.write = function(output) {
  ...
  if (this.extBin !== null && this.extBin !== undefined) {
    output.writeFieldBegin('extBin', Thrift.Type.STRING, 7);
    output.writeBinary(this.extBin);
    output.writeFieldEnd();
  }
  if (this.extTxt !== null && this.extTxt !== undefined) {
    output.writeFieldBegin('extTxt', Thrift.Type.STRING, 8);
    output.writeString(this.extTxt);
    output.writeFieldEnd();
  }
  if (this.createTime !== null && this.createTime !== undefined) {
...
ServiceSecurityException = function(args) {
  this.message = null;
  this.causeClass = null;
  this.serviceStackTraceMessage = null;
  this.causeFields = null;

  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem492 = null;
          elem492 = new FaceBean();
          elem492.read(input);
          this.faceBeans.push(elem492);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
IFaceLog_savePersonWithPhotoAndFeatureMultiFaces_args.prototype.write = function(output) {
  ...
  if (this.faceBeans !== null && this.faceBeans !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.faceBeans.length);
    for (var iter493 in this.faceBeans)
    {
      if (this.faceBeans.hasOwnProperty(iter493))
      {
        iter493 = this.faceBeans[iter493];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i499 = 0; _i499 < _size494; ++_i499)
        {
          ...
          var key500 = null;
          var val501 = null;
          key500 = input.readBinary().value;
          val501 = new FaceBean();
          val501.read(input);
          this.faceInfo[key500] = val501;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
IFaceLog_savePersonWithPhotoAndFeatureMultiImage_args.prototype.write = function(output) {
  ...
  if (this.faceInfo !== null && this.faceInfo !== undefined) {
    ...
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRUCT, Thrift.objectLength(this.faceInfo));
    for (var kiter502 in this.faceInfo)
    {
      if (this.faceInfo.hasOwnProperty(kiter502))
      {
        var viter503 = this.faceInfo[kiter502];
        output.writeBinary(kiter502);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem510 = null;
          elem510 = new PersonBean();
          elem510.read(input);
          this.persons.push(elem510);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
IFaceLog_savePersons_args.prototype.write = function(output) {
  ...
  if (this.persons !== null && this.persons !== undefined) {
    ...
    for (var iter511 in this.persons)
    {
      if (this.persons.hasOwnProperty(iter511))
      {
        iter511 = this.persons[iter511];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        var _ktype513 = 0;
        var _vtype514 = 0;
        _rtmp3516 = input.readMapBegin();
        _ktype513 = _rtmp3516.ktype;
        _vtype514 = _rtmp3516.vtype;
        ...
        for (var _i517 = 0; _i517 < _size512; ++_i517)
        {
          ...
          var key518 = null;
          var val519 = null;
          key518 = input.readBinary().value;
          val519 = new PersonBean();
          val519.read(input);
          this.persons[key518] = val519;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
IFaceLog_savePersonsWithPhoto_args.prototype.write = function(output) {
  ...
  if (this.persons !== null && this.persons !== undefined) {
    ...
    for (var kiter520 in this.persons)
    {
      if (this.persons.hasOwnProperty(kiter520))
      {
        var viter521 = this.persons[kiter520];
        output.writeBinary(kiter520);
        viter521.write(output);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem528 = null;
          elem528 = input.readI32().value;
          this.personIdList.push(elem528);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
IFaceLog_setPersonExpiryDateList_args.prototype.write = function(output) {
  ...
  if (this.personIdList !== null && this.personIdList !== undefined) {
    output.writeFieldBegin('personIdList', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.I32, this.personIdList.length);
    for (var iter529 in this.personIdList)
    {
      if (this.personIdList.hasOwnProperty(iter529))
      {
        iter529 = this.personIdList[iter529];
        output.writeI32(iter529);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        var _ktype531 = 0;
        var _vtype532 = 0;
        _rtmp3534 = input.readMapBegin();
        _ktype531 = _rtmp3534.ktype;
        _vtype532 = _rtmp3534.vtype;
        ...
        for (var _i535 = 0; _i535 < _size530; ++_i535)
        {
          ...
          var key536 = null;
          var val537 = null;
          key536 = input.readString().value;
          val537 = input.readString().value;
          this.config[key536] = val537;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
IFaceLog_setProperties_args.prototype.write = function(output) {
  ...
  if (this.config !== null && this.config !== undefined) {
    ...
    for (var kiter538 in this.config)
    {
      if (this.config.hasOwnProperty(kiter538))
      {
        var viter539 = this.config[kiter538];
        output.writeString(kiter538);
        output.writeString(viter539);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
...
IFaceLogClient.prototype.addFeatureMulti = function(feature, personId, faceInfo, token, callback) {
  if (callback === undefined) {
    this.send_addFeatureMulti(feature, personId, faceInfo, token);
    return this.recv_addFeatureMulti();
  } else {
    var postData = this.send_addFeatureMulti(feature, personId, faceInfo, token, true);
    return this.output.getTransport()
      .jqRequest(this, postData, arguments, this.recv_addFeatureMulti);
  }
};

IFaceLogClient.prototype.send_addFeatureMulti = function(feature, personId, faceInfo, token, callback) {
...
IFaceLogClient.prototype.addFeatureWithImage = function(feature, personId, asIdPhotoIfAbsent, featurePhoto, faceBean, token, callback) {
  if (callback === undefined) {
    this.send_addFeatureWithImage(feature, personId, asIdPhotoIfAbsent, featurePhoto, faceBean, token);
    return this.recv_addFeatureWithImage();
  } else {
    var postData = this.send_addFeatureWithImage(feature, personId, asIdPhotoIfAbsent, featurePhoto, faceBean, token, true);
    return this.output.getTransport()
      .jqRequest(this, postData, arguments, this.recv_addFeatureWithImage);
  }
};

IFaceLogClient.prototype.send_addFeatureWithImage = function(feature, personId, asIdPhotoIfAbsent, featurePhoto, faceBean, token, callback) {
...
IFaceLogClient.prototype.savePersonFull = function(personBean, idPhoto, feature, featureImage, featureFaceBean, token, callback) {
  if (callback === undefined) {
    this.send_savePersonFull(personBean, idPhoto, feature, featureImage, featureFaceBean, token);
    return this.recv_savePersonFull();
  } else {
    var postData = this.send_savePersonFull(personBean, idPhoto, feature, featureImage, featureFaceBean, token, true);
    return this.output.getTransport()
      .jqRequest(this, postData, arguments, this.recv_savePersonFull);
  }
};

IFaceLogClient.prototype.send_savePersonFull = function(personBean, idPhoto, feature, featureImage, featureFaceBean, token, callback) {
...
IFaceLogClient.prototype.savePersonWithPhotoAndFeatureMultiFaces = function(personBean, idPhoto, feature, faceBeans, token, callback) {
  if (callback === undefined) {
    this.send_savePersonWithPhotoAndFeatureMultiFaces(personBean, idPhoto, feature, faceBeans, token);
    return this.recv_savePersonWithPhotoAndFeatureMultiFaces();
  } else {
    var postData = this.send_savePersonWithPhotoAndFeatureMultiFaces(personBean, idPhoto, feature, faceBeans, token, true);
    return this.output.getTransport()
      .jqRequest(this, postData, arguments, this.recv_savePersonWithPhotoAndFeatureMultiFaces);
  }
};

IFaceLogClient.prototype.send_savePersonWithPhotoAndFeatureMultiFaces = function(personBean, idPhoto, feature, faceBeans, token, callback) {
...
IFaceLogClient.prototype.savePersonWithPhotoAndFeatureMultiImage = function(personBean, idPhoto, feature, faceInfo, token, callback) {
  if (callback === undefined) {
    this.send_savePersonWithPhotoAndFeatureMultiImage(personBean, idPhoto, feature, faceInfo, token);
    return this.recv_savePersonWithPhotoAndFeatureMultiImage();
  } else {
    var postData = this.send_savePersonWithPhotoAndFeatureMultiImage(personBean, idPhoto, feature, faceInfo, token, true);
    return this.output.getTransport()
      .jqRequest(this, postData, arguments, this.recv_savePersonWithPhotoAndFeatureMultiImage);
  }
};

IFaceLogClient.prototype.send_savePersonWithPhotoAndFeatureMultiImage = function(personBean, idPhoto, feature, faceInfo, token, callback) {
